  ...
  <div :class="darkMode() ? 'darkBG' : 'lightBG'">
    ...
    <div class="main">
      ...
      <vue-typed-js
        ...
        :showCursor="false"
        :loop="true"
        :strings="[greetings() + ', ' + nicknames + '! ^5000', 'Apakabar qill ? sehatt ? ^2500', 'gimana puasanyaa? bolong berapa hayoo.. wkwk ?  ^2500', 'semangat yaa belajarnyaa... :< ^2500', 'have a goodday qill, daaa...' ]"
        :backDelay="500"
        :typeSpeed="100"
        :backSpeed="20"
        :contentType="'null'"
